export const navItems = [
  ...
  export const gridItems = [
    {
      id: 1,
      title: "Fostering client partnerships through clear and open dialogue.",
      description: "",
    ...
    {
      id: 2,
      title: "Flexible availability for communication across time zones",
      description: "",
    ...
    },
    {
      id: 3,
      title: "My tech stack",
      description: "I'm continuously learning",
      className: "lg:col-span-2 md:col-span-3 md:row-span-2",
      imgClassName: "",
    ...
    {
      id: 4,
      title: "Passionate tech enthusiast dedicated to cutting-edge development.",
      description: "",
    ...
    {
      id: 5,
      title: "Currently building a secure dApp",
      description: "The SecureChain dApp",
